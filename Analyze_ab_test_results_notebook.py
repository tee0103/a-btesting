...
non_match=df.query('group=="treatment" & landing_page=="old_page"')['user_id'].count()
non_match
...
#for _ in range(10000):
   # samp_ab=df.sample(df.shape[0], replace=True)
    #new_page_converted=samp_ab.query('landing_page=="new_page" & group=="treatment" & converted=="1"')['user_id'].nunique()/samp_ab.user_id.nunique()
    #old_page_converted=samp_ab.query('landing_page=="old_page" & group=="control" & converted=="1"')['user_id'].nunique()/samp_ab.user_id.nunique()
...
#p_diffs = np.random.binomial(samp_ab.query('group=="treatment"')['user_id'].nunique(), conv_pnew, 10000)/samp_ab.query('group=="treatment"')['user_id'].nunique() - np.random.binomial(samp_ab.query('group=="control"')['user_id'].nunique(), conv_pold, 10000)/samp_ab.query('group=="control"')['user_id'].nunique()
#p_diffs = np.random.binomial(samp_ab.query('group=="treatment"')['user_id'].nunique(), new_page_converted, 10000)/samp_ab.query('group=="treatment"')['user_id'].nunique() - np.random.binomial(samp_ab.query('group=="control"')['user_id'].nunique(), old_page_converted, 10000)/samp_ab.query('group=="control"')['user_id'].nunique()


#p_diffs = np.random.binomial(samp_ab.query('group=="treatment"')['user_id'].nunique(), conv_pnew, 10000)/samp_ab.query('group=="treatment"')['user_id'].nunique() - np.random.binomial(samp_ab.query('group=="control"')['user_id'].nunique(), old_page_converted, 10000)/samp_ab.query('group=="control"')['user_id'].nunique()
#p_diffs = np.array(p_diffs)
...
#n_old = samp_ab.query('group=="control"')['user_id'].nunique()
#n_new = samp_ab.query('group=="treatment"')['user_id'].nunique()
...
# p-value =0.190. This value differs compared to that part 2 due two
